...
metadata {
	...
	definition(name: "Mutable SmartPower Outlet", namespace: "ajpri", author: "ajpri", ocfDeviceType: "oic.d.smartplug") {
		capability "Actuator"
		capability "Switch"
...
def parse(String description) {
	...
	if (event) {
		if (event.name == "power") {
			...
			event = createEvent(name: event.name, value: value, descriptionText: '{{ device.displayName }} power is {{ value }} Watts', translatable: true, displayed: logPower)
