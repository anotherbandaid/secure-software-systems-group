...
def mainPage() {
	dynamicPage(name: "mainPage") {
		...
		section{
            input "actionType", "enum", title: "Action?", required: true, defaultValue: "Message",submitOnChange:true, options: ["Message","Sound","Track","Radio Tunes","Multiple Radio Tunes","My Radio Station"]
        }
        ...
        section{  
            ...
            input "radiostation", "text", title: "Play Specific Station?", required: actionType == "Radio Station"? true:flase, defaultValue: "Enter Full Station URL"
...
private takeAction(evt) {
    ...
    switch(actionType) {
        ...
        case "My Radio Station":
            sonos.playTrack("$radiostation", volume)
            break
		case "Track":
