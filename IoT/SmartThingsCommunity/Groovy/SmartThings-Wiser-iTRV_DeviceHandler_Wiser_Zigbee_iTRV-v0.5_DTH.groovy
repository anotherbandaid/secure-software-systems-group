...
metadata {
	definition (name: "Wiser Zigbee iTRV - Update v0.5", namespace: "gszabados", author: "gszabados", mnmn: "SmartThings", vid: "generic-radiator-thermostat") {
		...
		else if (descMap.cluster == "FE03" && descMap.attrId == "0020" && descMap.encoding == "42")
		{
			...
			if (decodedMessage?.startsWith("UI,"))
			{
				...
				if (map.value == "BoostDown")
				{
					...
					log.debug "BoostDown Target Temperature: $boostDownTemp"
