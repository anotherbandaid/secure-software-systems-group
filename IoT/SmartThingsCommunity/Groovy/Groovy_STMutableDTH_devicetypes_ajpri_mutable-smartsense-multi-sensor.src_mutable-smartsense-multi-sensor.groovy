...
metadata {
	definition(name: "Mutable SmartSense Multi Sensor", namespace: "ajpri", author: "ajpri") {
	...
	preferences {
        ...
        section {
        	input "logTemp", "bool", title: "Show Temperature in Activity Feed" , description: "Show Temperature in feed.", displayDuringSetup: false
			input "logAccel", "bool", title: "Show Acceleration in Activity Feed" , description: "Show Temperature in feed.", displayDuringSetup: false
        }
	}
